...
UPDATE healthcare_professionals SET dni = '30542195' WHERE email = 'direccionmedica@INSTITUTION_DOMAIN';
UPDATE healthcare_professionals SET dni = '25178661' WHERE email = 'gerencia@INSTITUTION_DOMAIN';
UPDATE healthcare_professionals SET dni = '22610308' WHERE email = 'carlos.rodriguez@INSTITUTION_DOMAIN';
UPDATE healthcare_professionals SET dni = '30519253' WHERE email = 'maria.cardenau@INSTITUTION_DOMAIN';
UPDATE healthcare_professionals SET dni = '23111618' WHERE email = 'daniela.aquino@INSTITUTION_DOMAIN';
